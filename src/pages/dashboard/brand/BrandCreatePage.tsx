    ...
    <FormLayout title="Create Brand">
      <form onSubmit={(e) => { e.preventDefault(); void form.submit(); }} style={{ display: "grid", gap: 10 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}>
          <Button type="submit" disabled={form.isSubmitting || create.isPending}>
          ...
          <Button type="button" variant="outline" disabled={form.isSubmitting || create.isPending} onClick={() => navigate("/dashboard/brand")}>
            Cancel
          </Button>
        </div>
      </form>
