...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        " min-w-32 overflow-hidden rounded-xs border border-slate-200 bg-white p-1 text-slate-900 opacity-100 shadow-md",
